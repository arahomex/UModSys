...
//***************************************
  ...
  #define _UMODSYS_SOURCEINFO (&::NanoUTL::core::SSourceContext(__FILE__, __LINE__, __FUNCTION__))
  #define _UMODSYS_SOURCEINFON (&::NanoUTL::core::SSourceContext(__FILE__, __LINE__, NULL))
  #define _UMODSYS_SOURCEINFOZ ((::NanoUTL::core::SSourceContext*)NULL)
