...
struct U16String {
  ...
  U16String(const char *text) { if(text==NULL) text=""; gracial_convert(buf, Length+1, text, strlen(text)); }
  U16String(const char *text, int tlen) { gracial_convert(buf, Length+1, text, tlen); }
  U16String(void) {}
  //
...
struct U8String {
  ...
  U8String(const wchar_t *text) { if(text==NULL) text=L""; gracial_convert(buf, Length+1, text, wcslen(text)); }
  U8String(const wchar_t *text, int tlen) { gracial_convert(buf, Length+1, text, tlen); }
  U8String(void) {}
  //
...
bool gracial_convert(char *dest, int destsize, const wchar_t* src, int srcsize);
bool gracial_convert(wchar_t *dest, int destsize, const char* src, int srcsize);
