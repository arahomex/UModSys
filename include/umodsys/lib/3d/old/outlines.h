#ifndef __UMS_LIB3D_BRUSH_OUTLINES_H
#define __UMS_LIB3D_BRUSH_OUTLINES_H 1
//*****************************************************
// lib3d/outlines.h: common 3d library interfaces, brush outlines
//*****************************************************
...
struct IObjectBrushOutlineSphere : public IObjectBrushOutline {
  ...
  //
  virtual bool get_sphere(DPoint &C, BScalar& R) =0;
};
...
struct IObjectBrushOutlineCylinder : public IObjectBrushOutline {
  ...
  //
  virtual bool get_cylinder(DPoint &C, DPoint &Dir, BScalar& R) =0;
};
